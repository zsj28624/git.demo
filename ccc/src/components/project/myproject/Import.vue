<template>
  <div class="page page-bill page-bill-max">
    <CorpTabs tabvalue="zyxmsq" :projectId="projectId" :source="source"></CorpTabs>
    <br />
    <Loading :loading="loading">
            ...
            <tr>
              <td >
                <FormItem label="所属园区" prop="campusId">
                  <Input v-model="formItem.campusName" type="text" readonly style="width:100%;"></Input>
              ...
              <td >
                <FormItem label="所属楼盘" prop="buildingId">
                  <Input v-model="formItem.buildingNumber" type="text" readonly style="width:100%;"></Input>
              ...
              <td >
                <FormItem label="房间编号" prop="roomId">
                  <Input v-model="formItem.roomNumber" type="text" readonly  style="width:100%;"></Input>
      ...
      <table class="savebar" cellpadding="0" cellspacing="0" style="width:75%;">
        <tr v-if="!isView">
    ...
    getProject() {
      ...
      this.$http.post('/api/engine/project/get', { id: this.projectId }).then((res) => {
        if (res.data.code == 0 && res.data.data != null) {
          ...
          this.oriItem.relStep='重点项目';
          if(this.oriItem.status==1||this.oriItem.step=="待入库"||this.oriItem.step=="重点项目"||this.oriItem.step=="正式签约"){
            this.isView=true;
