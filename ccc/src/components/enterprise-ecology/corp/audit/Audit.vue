  ...
  <div class="page page-bill pay-edit">
    <div class="page-bar">
      <LayoutHor>
        ...
        <div class="page-bar-title">审批</div>
      </LayoutHor>
    </div>
        ...
        <div class="page-form">
          ...
          >
            ...
            <table cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td colspan="4">
                  <FormItem label="审批意见" prop>
                    <Input type="textarea" :rows="2" v-model="auditRemark" placeholder />
                  </FormItem>
                </td>
              </tr>
              <tr>
                <td colspan="4">
                  <FormItem>
                    <Button @click="save(2)" type="default" icon="md-checkmark">通过</Button>
                    <Button @click="save(3)" type="primary">驳回</Button>
                  </FormItem>
                </td>
              </tr>
            </table>
...
export default {
  ...
  methods: {
    save(auditStatus) {
      let url = '';
      if (this.type == 1) {//基本信息审核
        url = '/api/engine/enterprise-ecology/corp/audit/ecologyAudit';
      }
      if (this.type == 2) {//证书审核
        url = '/api/engine/enterprise-ecology/corp/audit/certificateAudit';
      }
      if (auditStatus == 3) {
      ...
      var prompt = auditStatus == 2 ? "通过" : "驳回";
      this.$Modal.confirm({
        title: '确认审核',
        content: '<p>确定' + prompt + '吗？</p>',
        onOk: () => {
          var form = {};
          form.id = this.applyId;
          form.auditStatus = auditStatus;
          form.auditRemark = this.auditRemark;
          this.loading = 1;
