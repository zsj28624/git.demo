            ...
            <tr>
              <td>
                <FormItem label="中国系统现代数字城市+生态解决方案模板" prop="szcs">
                  <UploadBox v-model="formItem.szcs" :readonly="false"></UploadBox>
                </FormItem>
              </td>
              <td>
                <FormItem label="生态伙伴产品、技术、解决方案白皮书（多个）" prop>
                  <UploadBox v-model="formItem.cpjs" :readonly="false"></UploadBox>
                </FormItem>
              </td>
            </tr>
            <tr>
              <td>
                <FormItem label="解决方案、产品报价（存在多条多版本）" prop>
                  <UploadBox v-model="formItem.bj" :readonly="false"></UploadBox>
                </FormItem>
              </td>
              <td>
                <FormItem label="成功案例介绍" prop>
                  <UploadBox v-model="formItem.cgal" :readonly="false"></UploadBox>
                </FormItem>
              </td>
            </tr>
            <tr>
              <td>
                <FormItem label="营业执照扫描件" prop="yyzz">
                  <UploadBox v-model="formItem.yyzz" :readonly="false"></UploadBox>
                </FormItem>
              </td>
              <td>
                <FormItem label="法人身份证扫描件" prop>
                  <UploadBox v-model="formItem.frsfz" :readonly="false"></UploadBox>
                </FormItem>
              </td>
            </tr>
            <tr>
