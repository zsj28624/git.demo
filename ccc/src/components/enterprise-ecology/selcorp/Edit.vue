      ...
      <div class="page-form">
        ...
        >
          <table cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td>
                <FormItem label="生态企业名称" prop="corpName">
                  <Input v-model="formItem.corpName" placeholder disabled/>
                </FormItem>
              </td>
              <td>
                <FormItem label="企业法人信息" prop="corporation">
                  <Input v-model="formItem.corporation" placeholder disabled/>
                </FormItem>
              </td>
            </tr>
            <tr>
              <td>
                <FormItem label="生态企业对接人" prop="contactName">
                  <Input v-model="formItem.contactName" placeholder disabled/>
                </FormItem>
              </td>
              <td>
                <FormItem label="对接人职位" prop="contactPosition">
                  <Input v-model="formItem.contactPosition" placeholder disabled/>
                </FormItem>
              </td>
              <td>
                <FormItem label="对接人联系电话" prop="contactPhone">
                  <Input v-model="formItem.contactPhone" placeholder disabled/>
                </FormItem>
              </td>
            </tr>
            <tr>
              <td>
                <FormItem label="对接人微信" prop="contactWechat">
                  <Input v-model="formItem.contactWechat" placeholder disabled/>
                </FormItem>
              </td>
              <td>
                <FormItem label="对接人邮箱" prop="contactEmail">
                  <Input v-model="formItem.contactEmail" placeholder disabled/>
                </FormItem>
              </td>
              <td>
                <FormItem label="注册资金" prop="registeredCapital">
                  <Input v-model="formItem.registeredCapital" placeholder disabled/>
                </FormItem>
              </td>
            </tr>
            <tr>
              <td>
                <FormItem label="公司规模" prop="companySize">
                  <Select v-model="formItem.companySize" disabled>
                    <Option
              ...
              <td>
                <FormItem label="企业级别" prop="enterpriseLevel">
                  <Select v-model="formItem.enterpriseLevel" disabled>
                    <Option
              ...
              <td>
                <FormItem label="年销售额" prop="usd">
                  <Select v-model="formItem.usd" disabled>
                    <Option
                      v-for="item in usd"
                      :value="item.argCode"
                      :key="item.argCode"
            ...
            <tr>
              <td colspan="2">
                <FormItem label="企业官网" prop="website">
                  <Input v-model="formItem.website" placeholder disabled/>
                </FormItem>
              </td>
              <td></td>
            </tr>
            <tr>
              <td colspan="2">
                <FormItem label="企业所属地域" prop="district" disabled>
            ...
            <tr>
              <td>
                <FormItem label="生态管理员" prop="manager">
                  <Input v-model="formItem.managerName" icon="md-search" @on-click="SelectMember" disabled/>
                </FormItem>
              </td>
              <td>
                <FormItem label="生态管理员手机号" prop="managerPhone">
                  <Input v-model="formItem.managerPhone" placeholder disabled/>
                </FormItem>
              </td>
              <td></td>
            </tr>
...
import SelArea from '@/components/enterprise-ecology/selcorp/index';
