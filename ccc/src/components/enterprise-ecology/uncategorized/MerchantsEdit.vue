      ...
      <Loading :loading="loading">
        <div class="page-form">
          <Form
            ...
            class="form-item"
          >
            <FormItem label="新招商人员" prop="managerNew">
              <Input v-model="formItem.managerNewName" placeholder="新招商人员" icon="md-search" @on-click="SelectMember"/>
            </FormItem>
            <br/>
            <FormItem>
...
export default {
  ...
  data() {
    return {
      ...
      ruleValidate: {
        managerNew: [
          { required: true, message: '新招商人员不能为空' },
        ],
      }
    }
  },
